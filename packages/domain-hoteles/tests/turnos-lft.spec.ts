...
// hoteles/tests/unit/domain-hotel/turnos-lft.spec.ts: la plantilla de turnos de
// housekeeping/lavandería propuesta debe validarse contra la LFT (descansos, límite
// de horas, transición a jornada de 40h) antes de publicarse. Cruce puro (sin
// Postgres). Verificado cifra por cifra contra el original -- ningún caso se cambió.

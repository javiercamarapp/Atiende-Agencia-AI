// Fase 8 hoteles (REQ-BO-024, LFT art.132 fr.XXXIV) — cruce puro de lo trabajado
// (checador) contra lo programado (horario), sin tocar Postgres -- ver
// apps/api/tests/hoteles-asistencia.spec.ts para el recorrido HTTP completo
// (autoservicio/aislamiento/roles) y packages/domain-hoteles/migrations/
// 010_checador_asistencia.sql para la inmutabilidad real (cadena de hash + triggers
// de bloqueo append-only).

// Fase 11 hoteles (REQ-CRM-002, P1/F) — port literal de
// hoteles/tests/unit/domain-hotel/reputacion-clasificador.spec.ts (42 tests de
// referencia), solo la ruta de import cambia. Verifica: (1) cada tema del criterio
// de aceptación (limpieza, personal, ubicación, wifi, ruido, AC, desayuno, check-in,
// precio, sargazo), (2) un tema LOCAL NO ENTRENADO PREVIAMENTE (ninguna palabra
// clave del diccionario base) sigue clasificándose, (3) sentimiento con negación e
...
import {
  ...
  TICKET_TOPICS,
  type TopicMatch,
} from "../src/reputacion/clasificador.ts";
...
describe("clasificarResena — punto de entrada combinado (caso de aceptación completo)", () => {
  it("un tema local nuevo con sentimiento muy negativo, huésped en estancia: clasifica y dispara acción (criterio de aceptación)", () => {

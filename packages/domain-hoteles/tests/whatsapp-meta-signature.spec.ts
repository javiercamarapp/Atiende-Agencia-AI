// Port literal de domain-restaurantes/tests/whatsapp-meta-signature.spec.ts — la
// verificación HMAC no tiene negocio de vertical, mismos casos.
...
describe("verifyMetaSignature (hoteles) — HMAC sobre bytes crudos", () => {
  ...
  it("rechaza si el body fue alterado después de calcular la firma", async () => {

...
// embebido como data URI, mismo asset ya usado en esta sesión para portar el
// layout de los otros 4 paquetes), acento #1D4ED8 ya consistente con el resto del
// sistema de correo.
//
// escapeHtml se EXPORTA (nunca privada) porque el dato dinámico más sensible de
// este dominio es el nombre del huésped, que llega tal cual lo capturó recepción o
// el agente de voz/WhatsApp — nunca confiable sin escapar.
...
// Logo real de la marca "atiende" — SVG embebido como data URI, mismo asset exacto
// ya usado para portar packages/domain-{citas,rentas,licitaciones,despachos}/src/emails/layout.ts
// en esta misma sesión. NUNCA reemplazar por otro logo ni otro color de marca.
  ...
  <tr><td align="center" style="padding:44px 16px 36px 16px;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;max-width:100%;border-collapse:collapse;">
      ...
      <tr><td align="left" style="padding:26px 6px 0 6px;">
        <p style="margin:0 0 7px 0;font-family:${FUENTE};font-size:11px;line-height:17px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#5b6b82;">atiende&nbsp;&nbsp;&#183;&nbsp;&nbsp;Hoteles: reservas, folios y CFDI</p>

// Fase 6 hoteles (REQ-HK-008, P1/GOB) — port ~literal de
// hoteles/packages/domain-hotel/src/housekeeping/turnos-lft.ts (394L): la plantilla de
// turnos de housekeeping/lavandería propuesta debe validarse contra la Ley Federal del
// Trabajo ANTES de publicarse -- descansos, límite de horas y la transición
// legislativa hacia la jornada de 40 horas. Cruce puro (sin I/O), verificado cifra por
// cifra contra el original: NINGÚN número de este archivo se cambió.
//

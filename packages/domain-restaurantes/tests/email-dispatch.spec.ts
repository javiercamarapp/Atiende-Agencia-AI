...
describe("dispatchPendingEmailJobs", () => {
  it("sin RESEND_API_KEY: reclama el lote (encolado real por createOrder al dejar correo), cada job falla explícito, se marca 'failed' (reintentable) — NUNCA 'sent'", async () => {

...
-- se otorga aquí explícitamente para que los escenarios de assertions.sql
-- que prueban "UPDATE/DELETE bloqueados incluso para service_role" ejerciten
-- de verdad el TRIGGER de bloqueo de mutación (0A000), no un "permission
-- denied for schema" incidental que enmascararía si el trigger realmente
-- funciona.

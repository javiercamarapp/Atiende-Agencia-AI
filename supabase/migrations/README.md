...
## Orden actual (70 migraciones, timestamps 20240101000001 .. 20240101000070)
...
2. Cópiala aquí también, renombrada con el **siguiente timestamp libre en la
   secuencia** (el último usado hasta ahora es `20240101000070`; usa
   `20240101000071`, luego `...072`, etc., o cambia a timestamps reales

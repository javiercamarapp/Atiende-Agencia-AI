...
## Orden actual (71 migraciones, timestamps 20240101000001 .. 20240101000071)
...
2. Cópiala aquí también, renombrada con el **siguiente timestamp libre en la
   secuencia** (el último usado hasta ahora es `20240101000071`; usa
   `20240101000072`, luego `...073`, etc., o cambia a timestamps reales

...
// realmente los 17 crons declarados en vercel.json (falla si alguien agrega
...
describe("cadenciaMinutosPorRuta / rutasDeCronDeclaradas", () => {
  it("cubre los 17 crons reales de vercel.json, todos con cadencia diaria determinable", () => {

...
// realmente los 20 crons declarados en vercel.json (falla si alguien agrega
...
describe("cadenciaMinutosPorRuta / rutasDeCronDeclaradas", () => {
  it("cubre los 20 crons reales de vercel.json, todos con cadencia diaria determinable", () => {
    const rutas = rutasDeCronDeclaradas();
    expect(rutas.length).toBe(20);

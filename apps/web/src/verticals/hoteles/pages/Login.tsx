...
export function HotelesLoginPage({ apiBaseUrl }: HotelesLoginPageProps) {
  ...
  async function handleMagicLinkSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const resultado = await iniciarMagicLink(apiBaseUrl, correoMagicLink, "hoteles");
      if (!resultado.ok) {
          ...
          <div className="mt-10">
            <div className="w-full">
              ...
              <p className="login-entra mt-5 text-pretty text-[14px] leading-relaxed text-muted-foreground" style={{ animationDelay: "320ms" }}>
                ...
                <span className="font-semibold text-foreground">Pídele a tu hotel que te dé de alta.</span>
              </p>

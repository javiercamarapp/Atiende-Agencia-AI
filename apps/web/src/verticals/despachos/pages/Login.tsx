...
// con foto real (propia de despachos) + Ken Burns.
...
export function DespachosLoginPage({ apiBaseUrl }: DespachosLoginPageProps) {
  ...
  async function handleMagicLinkSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const resultado = await iniciarMagicLink(apiBaseUrl, correoMagicLink, "despachos");
      if (!resultado.ok) {
          ...
          <div className="mt-10">
            <div className="w-full">
              ...
              <p className="login-entra mt-2 text-[15px] leading-[1.6] text-muted-foreground" style={{ animationDelay: "140ms" }}>
                El panel de operación de tu despacho contable.
              </p>
